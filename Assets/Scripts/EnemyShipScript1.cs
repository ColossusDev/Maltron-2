...
public class EnemyShipScript1 : MonoBehaviour {
	...
	void Update () {
        ...
        {
            Instantiate(shot1, this.gameObject.transform.position + new Vector3(-0.3f, -0.3f, 0), shot1.transform.rotation * new Quaternion(0, 0, 2, 0));
            Instantiate(shot1, this.gameObject.transform.position + new Vector3(0.3f, -0.3f, 0), shot1.transform.rotation * new Quaternion(0, 0, 2, 0));
